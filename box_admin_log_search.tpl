	  		...
	  		<table style="width:90%;" class="table table-noborder table-sm m-auto">
			    <tr>
				 ...
				 <tr>
					...
					<div class="form-radio">
						<label class="form-check-label">
						<input type="radio" class="form-check-input" name="search_type" id="message_" value="radiobutton"> Wiadomość
						</label>
					</div>
					</td>
			    ...
			    <tr>
					...
					<div class="form-radio">
						<label class="form-check-label">
						<input type="radio" class="form-check-input" name="search_type" id="date_" value="radiobutton"> Data
						</label>
					</div>
					</td>
				    <td>
			    ...
			    <tr>
					...
					<div class="form-radio">
						<label class="form-check-label">
						<input type="radio" class="form-check-input" name="search_type" id="type_" value="radiobutton"> Typ
						</label>
					</div>
					</td>
			        <td>
						<select class="form-control" id="type" onmouseup="$('type_').checked = true" style="width: 100%;">
							<option label="Message" value="m">Wiadomość</option>
							<option label="Warning" value="w">Ostrzeżenie</option>
							<option label="Error" value="e">Błąd</option>
						</select>
					</td>
			    </tr>
			    <tr>
