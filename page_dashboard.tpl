				...
				<div class="card-statistics">
					<div class="card-body">
						<div class="clearfix">
							...
							<p class="mb-0 text-right" data-aos="flip-left" data-aos-delay="300">Serwery</p>
				...
				<div class="card-statistics">
					<div class="card-body">
						<div class="clearfix">
							...
							<p class="mb-0 text-right" data-aos="flip-left" data-aos-delay="500">Bany</p>
							<div class="fluid-container">
				...
				<div class="card-statistics">
					<div class="card-body">
						<div class="clearfix">
							...
							<p class="mb-0 text-right" data-aos="flip-left" data-aos-delay="700">Blokady</p>
							<div class="fluid-container">
				...
				<div class="card-statistics">
					<div class="card-body">
						<div class="clearfix">
							...
							<p class="mb-0 text-right" data-aos="flip-left" data-aos-delay="900">Łącznie zatrzymane połączenia</p>
							<div class="fluid-container">
...
<div class="row">
	<div class="col-lg-12 grid-margin" data-aos="fade-out"  data-aos-delay="150">
		<div class="card">
			<div class="card-body">
				<h4 class="card-title" style="margin-bottom:0px;">Ostatnio dodany ban</h4>
				<p class="card-description">
					<code>Liczba Banów:{$total_bans}</code>
				</p>
...
<div class="row">
	<div class="col-lg-6 grid-margin" data-aos="fade-out" data-aos-delay="250">
		<div class="card">
			<div class="card-body">
				<h4 class="card-title" style="margin-bottom:0px;">Ostanie dodane blokady</h4>
				<p class="card-description">
					<code>Bloków: {$total_comms}</code>
				</p>
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-hover tbl-sm">
						<thead>
	...
	<div class="col-lg-6 grid-margin" data-aos="fade-out" id="test" data-aos-delay="550">
		<div class="card">
			<div class="card-body">
				<h4 class="card-title" style="margin-bottom:0px;">Ostatnie Wygasłe Blokady</h4>
				<p class="card-description">
					<code>Liczba: {$total_blocked}</code>
				</p>
				<div class="table-responsive">
					<table class="table table-bordered table-striped table-hover tbl-sm">
						<thead>
