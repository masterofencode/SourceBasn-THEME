<html>
		...
		<script type="text/javascript">
			...
			function set_counter(count)
			{
				...
				if(srvcount==-{$total}- || count=='-1') {
					parent.document.getElementById('dialog-control').innerHTML = "<font color=\"green\" style=\"font-size: 12px;\"><b>Wyszukiwanie zakończone.</b></font>"+parent.document.getElementById('dialog-control').innerHTML;
	...
	<body style="
		...
		<div id="container" name="container">
			<h3 style="font-size: 12px;">Szukanie gracza po wszystkichc serwerach...</h3>
			<table border="0">
				...
				<tr>
					...
					<td>
						<div id="srv_-{$serv.num}-"><font size="1">Czekaj...</font></div>
					</td>
				</tr>
				-{/foreach}-
			</table>
