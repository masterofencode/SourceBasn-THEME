		...
		<div class="auto-form-wrapper py-3 p-lg-4" id="login-content">
			...
			<div class="form-group d-flex justify-content-between">
				<div class="form-check" id="loginRememberMeDiv">
					...
					<input id="loginRememberMe" type="checkbox" name="remember" value="checked" vspace="5px" class="form-check-input" checked=""> Zapamiętaj Logowanie
					<i class="input-helper"></i></label>
				</div>
				<a href="index.php?p=lostpassword" class="text-small forgot-password text-black">Przypomnij Hasło</a>
			</div>
			-{/if}-
