	...
	<div class="col-lg-12 grid-margin">
		<div class="card">
			<div class="card-body" id="add-group1">
				<h3>Archium odwołan od bana <i class="btn btn-outline-primary btn-rounded btn-fw" style="width:20px;height:20px;padding:0px;line-height:18px;">Liczba: {$protest_count_archiv}</i></h3>
				<p>Kliknij pseudonim gracza, aby wyświetlić informacje o jego banie</p>
				<br /><br />
					...
					<table class="table">
						...
						<tr style="cursor:pointer;" data-toggle="collapse" data-target="#expand_protestsa_{$protest.pid}" aria-expanded="false" aria-controls="collapseExample">
							...
							<td style="border-bottom: solid 1px #ccc">
								...
								<a href="#" onclick="RemoveProtest('{$protest.pid}', '{if $protest.authid!=""}{$protest.authid}{else}{$protest.ip}{/if}', '2');">Przywróc</a> -
								<a href="#" onclick="RemoveProtest('{$protest.pid}', '{if $protest.authid!=""}{$protest.authid}{else}{$protest.ip}{/if}', '0');">Skasuj</a> -
								{/if}
									...
									<table class="table tbl-sm" width="100%">
										...
										<tr align="left">
											<td height="16" align="left" class="listtable_1" colspan="2">
												<b>Zarchiwizowane ponieważ {$protest.archive}</b>
											</td>
										...
										<tr align="left">
											<td width="20%" height="16" class="listtable_1">Nadano w dniu</td>
											<td height="16" class="listtable_1">{$protest.date}</td>
										</tr>
										<tr align="left">
											<td width="20%" height="16" class="listtable_1">Kończy się</td>
											<td height="16" class="listtable_1">
										...
										<tr align="left">
											<td width="20%" height="16" class="listtable_1">Zbanowany przez</td>
										...
										<tr align="left">
											<td width="20%" height="16" class="listtable_1">Odwołanie z</td>
											<td height="16" class="listtable_1">{$protest.datesubmitted}</td>
										</tr>
										<tr align="left">
											<td width="20%" height="16" class="listtable_1">Wiadomość</td>
