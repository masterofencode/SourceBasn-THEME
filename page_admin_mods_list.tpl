...
<div class="row">
	<div class="col-lg-12 grid-margin">
		<div class="card">
			<div class="card-body">
				<h3>Lista Modów Serwerych <i class="btn btn-outline-primary btn-rounded btn-fw" style="width:20px;height:20px;padding:0px;line-height:18px;">Liczba: {$mod_count}</i></h3>
				<div id="banlist" class="table-responsive">
					<table class="table table-striped tbl-sm">
						<thead>
							<tr>
								<th width="50%">Nazwa</th>
								<th width="25%">Folder moda</th>
								<th width="10%">
									<center>Ikona moda</center>
								</th>
						...
						<tbody>
							...
							<tr id="mid_{$mod.mid}">
								...
								<td>
									...
									<a href="index.php?p=admin&c=mods&o=edit&id={$mod.mid}" class="badge badge-primary"><i class="icon-sm mdi mdi-pencil"></i>Edytuj</a> - 
									{/if}
									{if $permission_deletemods}
									<a href="#" onclick="RemoveMod('{$mod.name|escape:'quotes'|htmlspecialchars}', '{$mod.mid}');"  class="badge badge-danger"><i class="icon-sm mdi mdi-delete"></i>Usuń</a>
									{/if}
								</td>
								{/if}
							</tr>
