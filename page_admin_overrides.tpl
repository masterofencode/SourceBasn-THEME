		...
		<div class="card">
			<div class="card-body" id="add-group">
				<form action="" method="post">
					<h3>Overrides</h3>
					<p>Za pomocą override możesz zmieniać flagi lub uprawnienia do dowolnego polecenia, globalnie lub dla określonej grupy, bez edytowania kodu źródłowego wtyczki.<br />
						<i>Czytaj tu <b><a href="http://wiki.alliedmods.net/Overriding_Command_Access_%28SourceMod%29" title="Overriding Command Access (SourceMod)" target="_blank">overriding command access</a></b> znajdujący się na AlliedModders Wiki!</i><br /><br />
					</p>
					...
					<br />
					<center>
						{sb_button text="Zapisz" class="ok" id="oversave" submit=true}
						{sb_button text="Wstecz" onclick="history.go(-1)" class="cancel" id="oback"}
					</center>
				</form>
			</div>
		</div>
