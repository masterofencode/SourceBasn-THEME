<html>
	<head>
		<title>Wrzuć Plik : SourceBans</title>
	...
	<body bgcolor="e9e9e9" style="
		...
		">
		<h3>{$title}</h3>
		Wybierz plik do przesłania. Plik musi być albo {$formats} format pliku<br>
		<b>{$message}</b>
		<form action="" method="POST" id="{$form_name}" enctype="multipart/form-data">
			...
			<button style="background-color: #e9e9e9;
				...
				font-weight: bold;
				margin: 0 0.5em;
				background-image: url(../images/save.png);" type="submit">Zapisz</button>
		</form>
	</body>
</html>