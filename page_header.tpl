				...
				<div class="navbar-menu-wrapper d-flex align-items-center">
					<ul class="navbar-nav navbar-nav-right">
							...
							<div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
								<form method="get" action="index.php" id="banform">
									...
									<a class="dropdown-item">
										<p class="mb-0 font-weight-normal float-left">Szukaj Bana....
										</p>
									</a>
									<a class="dropdown-item preview-item">
										...
										<div class="preview-item-content">
											<input type="text" name="searchText" class="form-control" placeholder="Szukaj Bana ..." style="width:190px;">
										</div>
									</a>
								</form>
								...
								<form method="get" action="index.php" id="commform">
									...
									<a class="dropdown-item">
										<p class="mb-0 font-weight-normal float-left">Szukaj Blokad.....
										</p>
									</a>
									<a class="dropdown-item preview-item">
										...
										<div class="preview-item-content">
											<input type="text" name="searchText" class="form-control" placeholder="Szukaj Blokad..." style="width:190px;">
										</div>
									</a>
								</form>
								<div class="dropdown-divider"></div>
						...
						<li class="nav-item dropdown ">
							...
							<span class="profile-text d-none d-xl-inline-block">Witaj, {$username} !</span>
			...
			<div class="nav-link">
				...
				<div class="user-wrapper">
					...
					<div class="text-wrapper">
						...
						<div class="mt-2">
							<small class="designation text-muted"><a href='index.php?p=logout'>Wyloguj</a></small>
						</div>
					</div>
				</div>
				{else}
				<button onclick="location.href='index.php?p=login';" class="btn btn-success btn-block">Zaloguj się
				</button>
				{/if}
			</div>
		</li>