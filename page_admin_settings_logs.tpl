<div class="row">
	<div class="col-lg-12 grid-margin">
		<div class="card">
			<div class="card-body">
				<h3>System Logów {$clear_logs|replace:'href':'class="btn btn-outline-primary btn-rounded btn-fw" href'|replace:'(':''|replace:')':''}</h4></h3>
				<p>Kliknij wiersz, aby wyświetlić więcej szczegółów na temat wydarzenia.</p>
				<br /><br />
				...
				<div class="col-12 my-2 text-xl-right text-lg-left">
					...
					<table class="table table-hover table-sm">
						<thead>
							<tr>
								<th width="5%" class="listtable_top" align="center">Typ</th>
								<th width="28%" class="listtable_top" align="center">Zdarzenie</th>
								<th width="28%" class="listtable_top" align="center">Użytkownik</th>
							...
							<td colspan="7" align="center" style="padding:0;">
								<div class="collapse" id="expand_{$smarty.foreach.fe_log.index}" data-parent="#loglist">
									<table class="table tbl-sm" width="80%" style="width:80% !important;">
										...
										<tr align="left">
											<td width="20%" >Szczegóły</td>
											<td>{$log.message}</td>
										</tr>
										<tr align="left">
											<td width="20%" >Funkcja loga</td>
											<td>{$log.function}</td>
										</tr>
										<tr align="left">
											<td width="20%" >Ciąg zapytania</td>
