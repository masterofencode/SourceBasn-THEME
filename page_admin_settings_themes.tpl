         ...
         <div class="card-body">
            ...
            <div class="row">
               <div id="current-theme-holder" class="col-lg-6">
                  <h4 class="lead">Wybierz szablon: <span id="theme.name">{$theme_name}</span></h4>
               ...
               <div class="col-lg-6">
                  <h4 class="lead">Dostępne motywy</h4>
